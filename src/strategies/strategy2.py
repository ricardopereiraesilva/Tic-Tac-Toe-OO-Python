...
class Strategy2(Strategy):
    ...
    def getMove2(self, state):
        # strategyWay 1
        if (
                (state.occupiedPositionsOnTheLine(1) == 2)
            ...
            # strategyWay 2
            if ((state.occupiedPosition(1, 2)) and (state.occupiedPosition(3, 2))) or (
                    (state.occupiedPosition(2, 1)) and (state.occupiedPosition(2, 3))
            ):
                self.strategyWay = 2
                self.moveOrder += 1
                ...
                # strategyWay 3
                if ((state.occupiedPosition(1, 1)) and (state.occupiedPosition(3, 3))) or (
                        (state.occupiedPosition(3, 1)) and (state.occupiedPosition(1, 3))
                ):
                    self.strategyWay = 3
                    self.moveOrder += 1
                    ...
                    # strategyWay 4
                    if (
                            ((state.occupiedPosition(1, 2)) and (state.occupiedPosition(2, 3)))
                        ...
                        # strategyWay 5
                        if (
                                ((state.occupiedPosition(1, 2)) and (state.occupiedPosition(2, 1)))
                            ...
                            # strategyWay 6
                            if (
                                    ((state.occupiedPosition(3, 2)) and (state.occupiedPosition(1, 3)))
